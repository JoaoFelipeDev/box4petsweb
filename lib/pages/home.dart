...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<RacasModel> _listRacaGato = [];
    List<RacasModel> _originalListRacaCao = [];
  List<RacasModel> _originalListRacaGato = [];
...
void _filterListsBySearchQuery() {
  setState(() {
    if (searchQuery.isEmpty) {
      // Se o searchQuery estiver vazio, filtrar por selectedLetter
      _filterListsByLetter();
    } else {
      // Caso contrário, filtrar pelo searchQuery
      _listRacaCao = _originalListRacaCao
          .where((raca) => raca.Nome.toLowerCase().contains(searchQuery.toLowerCase()))
          .toList();
      _listRacaGato = _originalListRacaGato
          .where((raca) => raca.Nome.toLowerCase().contains(searchQuery.toLowerCase()))
          .toList();
    }
  });
}
  void _filterListsByLetter() {

    setState(() {
       _listRacaCao = _originalListRacaCao
          .where((raca) => raca.Nome.startsWith(selectedLetter))
          .toList();
      _listRacaGato = _originalListRacaGato
          .where((raca) => raca.Nome.startsWith(selectedLetter))
          .toList();
  ...
  _searchTracosCategory(String categoria) {
    setState(() {
      categiriasTracosSearch =
          categiriasTracosSearch == categoria ? '' : categoria;
    });
    ...
    return BlocListener<DoencasBloc, DoencasState>(
      ...
      listener: (context, state) {
        if (state is DoencasError) {
          ...
          setState(() {
            isLoading = false;
           // Armazene os dados carregados nas listas originais
            _originalListRacaCao = state.racasDog;
            _originalListRacaGato = state.racasCat;

            // Inicialize as listas filtradas com os dados originais
            _listRacaCao = _originalListRacaCao;
            _listRacaGato = _originalListRacaGato;
                        ...
                        child: Card(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Image.asset('assets/images/dog_desenho.png',
                                    height: 75),
                                const Text(
                                  'Doenças',
                        ...
                        child: Card(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                Image.asset('assets/images/dog_desenho_1.png',
                                    height: 75),
                                const Text(
                                  'Traços',
                        ...
                        children: categorias
                            .map((e) => InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: categiriasSearch == e
                                          ? const Color(0xff3F2873)
                                          : Colors.grey[200],
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => Doencas(
                                            selectedAnimal: _selectedAnimal,
                                            tapPaginator: _tapPaginator,
                                            openModal: _openModal,
                                            doencas: doencas,
                                            totalPage: totalPage,
                                            tipoDeBusca: _returnTypeSearch(),
                                            filtroCategoria: categiriasSearch,
                                            filtroRacas: filtroRacas,
                                          )));
                            },
                            child: Row(
                              children: [
                                Text(
                                  categiriasSearch.isEmpty
                                      ? 'Prosseguir com todas as categorias'
                                      : 'Prosseguir com $categiriasSearch',
                          ...
                          Radio(
                            ...
                            onChanged: (value) {
                              setState(() {
                                ...
                                _doencasBloc
                                    .add(GetDoencasEvent(_selectedAnimal));
                              });
                            },
                          ),
                          const Text(
                                ...
                                : InkWell(
                                    ...
                                    child: Row(
                                      children: [
                                        Text(
                                          filtroRacas.isEmpty
                                              ? 'Prosseguir com todas as raças'
                                              : 'Prosseguir com $filtroRacas',
                                          style: const TextStyle(
                                              color: Colors.black,
                                              fontSize: 20),
                                        ),
                ...
                children: [
                      ...
                      children: categoriasTracos
                          .map((e) => InkWell(
                                ...
                                child: Container(
                                  ...
                                  padding: const EdgeInsets.all(5),
                                  decoration: BoxDecoration(
                                    color: categiriasTracosSearch == e
                                        ? const Color(0xff3F2873)
                                        : Colors.grey[200],
                                    borderRadius: BorderRadius.circular(5),
                                  ),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      categiriasTracosSearch.isEmpty
                          ? Container()
                          : InkWell(
                              onTap: () {
                                Navigator.push(
                              ...
                              child: Row(
                                children: [
                                  Text(
                                    ...
                                    categiriasTracosSearch.isEmpty
                                        ? 'Prosseguir com todas as categorias'
                                        : 'Prosseguir com $categiriasTracosSearch',
                                    style: const TextStyle(
                            ...
                            if (state is DoencasLoading) {
                              ...
                              return SizedBox(
                                ...
                                child: GridView.count(
                                  ...
                                  crossAxisCount: 3,
                                  shrinkWrap: true,
                                  children: List.generate(state.doencas.length,
                                      (index) {
                                    final e = state.doencas[index];
                                    return InkWell(
                                      onTap: () {
                                        _openModal(e.doenca, e.sobre_doenca);
                                      },
                                      child: Container(
                                        height: 50,
                                        color: Colors.grey[200],
                ...
                if (state is DoencasLoading) {
                  ...
                  return SizedBox(
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          children:
                              List.generate(state.doencas.length, (index) {
                            final e = state.doencas[index];
                            return InkWell(
                              onTap: () {
                                _openModal(e.doenca, e.sobre_doenca);
